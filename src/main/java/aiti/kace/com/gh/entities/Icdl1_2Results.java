...
@Entity
@Table(name = "icdl1_2results")
public class Icdl1_2Results{
	...
	public Icdl1_2Results(int id, String student_id, int foc, int microsoft_word, int excel, int powerpoint,
