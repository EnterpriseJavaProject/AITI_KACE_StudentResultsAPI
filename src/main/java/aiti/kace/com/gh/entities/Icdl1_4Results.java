...
@Entity
@Table(name = "icdl1_4results")
public class Icdl1_4Results{
	...
	public Icdl1_4Results(int id, String student_id, int foc, int microsoft_word, int excel, int powerpoint,
