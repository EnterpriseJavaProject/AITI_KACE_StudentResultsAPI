...
@Entity
@Table(name = "ccna1_5results")
public class Ccna1_5Results{
	...
	public Ccna1_5Results(int id, String student_id, int networks, int routing_security_essentials,
