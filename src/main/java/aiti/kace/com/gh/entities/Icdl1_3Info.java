...
@Entity
@Table(name = "icdl1_3students")
public class Icdl1_3Info{
...
public Icdl1_3Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
