...
@Entity
@Table(name = "ccna1_2students")
public class Ccna1_2Info{
...
public Ccna1_2Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
