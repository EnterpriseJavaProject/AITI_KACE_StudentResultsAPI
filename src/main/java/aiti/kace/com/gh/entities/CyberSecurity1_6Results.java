...
@Entity
@Table(name = "cyber_security1_6results")
public class CyberSecurity1_6Results{
	...
	public CyberSecurity1_6Results() {
		super();
	}
	...
	public CyberSecurity1_6Results(int id, String student_id, int cyber_security_attacks, int cyber_security_methods,
