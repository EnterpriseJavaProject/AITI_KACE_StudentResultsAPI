...
@Entity
@Table(name = "icdl1_6results")
public class Icdl1_6Results{
	...
	public Icdl1_6Results(int id, String student_id, int foc, int microsoft_word, int excel, int powerpoint,
