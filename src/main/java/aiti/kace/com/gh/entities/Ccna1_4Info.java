...
@Entity
@Table(name = "ccna1_4students")
public class Ccna1_4Info{
...
public Ccna1_4Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
