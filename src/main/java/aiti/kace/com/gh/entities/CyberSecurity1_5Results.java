...
@Entity
@Table(name = "cyber_security1_5results")
public class CyberSecurity1_5Results{
	...
	public CyberSecurity1_5Results() {
		super();
	}
	...
	public CyberSecurity1_5Results(int id, String student_id, int cyber_security_attacks, int cyber_security_methods,
