...
@Entity
@Table(name = "cyber_security1_3results")
public class CyberSecurity1_3Results{
	...
	public CyberSecurity1_3Results() {
		super();
	}
	...
	public CyberSecurity1_3Results(int id, String student_id, int cyber_security_attacks, int cyber_security_methods,
