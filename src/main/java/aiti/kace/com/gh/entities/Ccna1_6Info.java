...
@Entity
@Table(name = "ccna1_6students")
public class Ccna1_6Info{
...
public Ccna1_6Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
