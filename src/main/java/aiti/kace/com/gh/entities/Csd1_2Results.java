...
@Entity
@Table(name = "csd1_2results")
public class Csd1_2Results{
	...
	public Csd1_2Results(int id, String student_id, int foc, int html_css, int javascript, int se, int database_tec,
			int python) {
		super();
		this.id = id;
