...
@Entity
@Table(name = "csd1_7results")
public class Csd1_7Results{
	...
	public Csd1_7Results(int id, String student_id, int foc, int html_css, int javascript, int se, int database_tec,
			int python) {
		super();
		this.id = id;
