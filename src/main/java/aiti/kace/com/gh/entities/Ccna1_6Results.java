...
@Entity
@Table(name = "ccna1_6results")
public class Ccna1_6Results{
	...
	public Ccna1_6Results(int id, String student_id, int networks, int routing_security_essentials,
