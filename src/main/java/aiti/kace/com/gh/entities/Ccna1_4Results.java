...
@Entity
@Table(name = "ccna1_4results")
public class Ccna1_4Results{
	...
	public Ccna1_4Results(int id, String student_id, int networks, int routing_security_essentials,
