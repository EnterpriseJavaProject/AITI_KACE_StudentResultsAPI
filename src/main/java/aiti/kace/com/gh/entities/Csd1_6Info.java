...
@Entity
@Table(name = "csd1_6students")
public class Csd1_6Info{
...
public Csd1_6Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
