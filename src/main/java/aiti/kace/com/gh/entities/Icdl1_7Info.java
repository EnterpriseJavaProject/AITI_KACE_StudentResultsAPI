...
@Entity
@Table(name = "icdl1_7students")
public class Icdl1_7Info{
...
public Icdl1_7Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
