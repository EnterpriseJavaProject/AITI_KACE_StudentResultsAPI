...
@Entity
@Table(name = "csd1_5students")
public class Csd1_5Info{
...
public Csd1_5Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
