...
@Entity
@Table(name = "csd1_4students")
public class Csd1_4Info{
...
public Csd1_4Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
