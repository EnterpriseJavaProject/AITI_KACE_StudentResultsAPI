...
@Entity
@Table(name = "icdl1_4students")
public class Icdl1_4Info{
...
public Icdl1_4Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
