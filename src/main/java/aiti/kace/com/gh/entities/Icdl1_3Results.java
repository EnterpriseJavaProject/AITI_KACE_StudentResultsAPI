...
@Entity
@Table(name = "icdl1_3results")
public class Icdl1_3Results{
	...
	public Icdl1_3Results(int id, String student_id, int foc, int microsoft_word, int excel, int powerpoint,
