...
@Entity
@Table(name = "ccna1_5students")
public class Ccna1_5Info{
...
public Ccna1_5Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
