...
@Entity
@Table(name = "icdl1_2students")
public class Icdl1_2Info{
...
public Icdl1_2Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
