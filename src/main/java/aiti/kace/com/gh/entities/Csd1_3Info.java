...
@Entity
@Table(name = "csd1_3students")
public class Csd1_3Info{
...
public Csd1_3Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
