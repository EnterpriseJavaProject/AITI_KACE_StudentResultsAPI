...
@Entity
@Table(name = "icdl1_1students")
public class Icdl1_1Info{
...
public Icdl1_1Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
