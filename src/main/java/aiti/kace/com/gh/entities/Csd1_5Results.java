...
@Entity
@Table(name = "csd1_5results")
public class Csd1_5Results{
	...
	public Csd1_5Results(int id, String student_id, int foc, int html_css, int javascript, int se, int database_tec,
			int python) {
		super();
		this.id = id;
