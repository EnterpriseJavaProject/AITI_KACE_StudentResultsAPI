...
@Entity
@Table(name = "icdl1_5students")
public class Icdl1_5Info{
...
public Icdl1_5Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
