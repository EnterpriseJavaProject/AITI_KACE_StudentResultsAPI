...
@Entity
@Table(name = "ccna1_1results")
public class Ccna1_1Results{
	...
	public Ccna1_1Results(int id, String student_id, int networks, int routing_security_essentials,
