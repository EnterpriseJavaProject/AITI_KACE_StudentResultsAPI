...
@Entity
@Table(name = "icdl1_7results")
public class Icdl1_7Results{
	...
	public Icdl1_7Results(int id, String student_id, int foc, int microsoft_word, int excel, int powerpoint,
