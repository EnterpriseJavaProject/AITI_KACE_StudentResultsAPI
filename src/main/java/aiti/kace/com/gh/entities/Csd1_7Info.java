...
@Entity
@Table(name = "csd1_7students")
public class Csd1_7Info{
...
public Csd1_7Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
