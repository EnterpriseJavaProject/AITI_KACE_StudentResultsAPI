...
@Entity
@Table(name = "cyber_security1_7results")
public class CyberSecurity1_7Results{
	...
	public CyberSecurity1_7Results() {
		super();
	}
	...
	public CyberSecurity1_7Results(int id, String student_id, int cyber_security_attacks, int cyber_security_methods,
