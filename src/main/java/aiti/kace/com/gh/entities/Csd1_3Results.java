...
@Entity
@Table(name = "csd1_3results")
public class Csd1_3Results{
	...
	public Csd1_3Results(int id, String student_id, int foc, int html_css, int javascript, int se, int database_tec,
			int python) {
		super();
		this.id = id;
