...
@Entity
@Table(name = "cyber_security1_2results")
public class CyberSecurity1_2Results{
	...
	public CyberSecurity1_2Results() {
		super();
	}
	...
	public CyberSecurity1_2Results(int id, String student_id, int cyber_security_attacks, int cyber_security_methods,
