...
@Entity
@Table(name = "icdl1_6students")
public class Icdl1_6Info{
...
public Icdl1_6Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
