...
@Entity
@Table(name = "icdl1_5results")
public class Icdl1_5Results{
	...
	public Icdl1_5Results(int id, String student_id, int foc, int microsoft_word, int excel, int powerpoint,
