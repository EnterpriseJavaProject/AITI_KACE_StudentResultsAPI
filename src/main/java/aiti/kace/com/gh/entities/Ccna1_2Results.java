...
@Entity
@Table(name = "ccna1_2results")
public class Ccna1_2Results{
	...
	public Ccna1_2Results(int id, String student_id, int networks, int routing_security_essentials,
