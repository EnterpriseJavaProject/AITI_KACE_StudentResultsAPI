...
@Entity
@Table(name = "cyber_security1_4results")
public class CyberSecurity1_4Results{
	...
	public CyberSecurity1_4Results() {
		super();
	}
	...
	public CyberSecurity1_4Results(int id, String student_id, int cyber_security_attacks, int cyber_security_methods,
