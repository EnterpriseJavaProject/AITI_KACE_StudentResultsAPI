...
@Entity
@Table(name = "csd1_2students")
public class Csd1_2Info{
...
public Csd1_2Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
