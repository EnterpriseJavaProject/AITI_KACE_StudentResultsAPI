...
@Entity
@Table(name = "ccna1_7results")
public class Ccna1_7Results{
	...
	public Ccna1_7Results(int id, String student_id, int networks, int routing_security_essentials,
