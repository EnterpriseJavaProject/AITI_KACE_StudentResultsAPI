...
@Entity
@Table(name = "ccna1_3students")
public class Ccna1_3Info{
...
public Ccna1_3Info(int id, String student_id, String student_name, String course, String email, String phone,
		String gender) {
	super();
	this.id = id;
